...
<head>
    ...
    <title>Contacts | GRANFO</title>
    <meta name="description" content="Contact Granfo Luce. Showroom in Verona, bespoke design, and customer support.">
...
<body>
    ...
    <nav class="navbar">
        <div class="container nav-container">
            ...
            <div class="nav-actions">
                ...
                <div class="lang-selector"><a href="../contatti.php" class="lang-item">IT</a><a href="#" class="lang-item active">EN</a></div>
    ...
    <div id="search-overlay" class="search-overlay">
        <button class="close-search" onclick="toggleSearch()" aria-label="Close search">&times;</button>
    ...
    <header class="page-header">
        ...
        <div class="container page-title">
            <p class="breadcrumb"><a href="index.php">Home</a> / <span>Contacts</span></p>
            <h1>Let's talk about light</h1>
        </div>
    </header>
        ...
        <div class="container">
            <div class="split-layout" style="align-items: flex-start;">
                ...
                <div class="contact-info reveal">
                    ...
                    <h2 style="font-family: var(--font-serif); margin-bottom: 2rem; color: white; font-size: 2.5rem;">Headquarters & Showroom</h2>
                    ...
                    <ul class="info-list">
                        <li>
                            ...
                            <div>
                                <strong style="color: white; font-size: 1.1rem;">Address</strong><br>
                                <span style="color: var(--color-text-muted);">Via Ponte S. Pancrazio 8/a<br>37133 Verona (VR), Italy</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                ...
                                <a href="mailto:granfoluce@hotmail.it" style="color: var(--color-accent); text-decoration: underline;">granfoluce@hotmail.it</a>
                            </div>
                        </li>
                        <li>
                            <div class="icon-box"><svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg></div>
                            <div>
                                <strong style="color: white; font-size: 1.1rem;">Phone</strong><br>
                        ...
                        <li>
                            ...
                            <div>
                                <strong style="color: white; font-size: 1.1rem;">Opening hours</strong><br>
                                <span style="color: var(--color-text-muted);">Mon:</span> 15:30 - 19:30<br>
                                <span style="color: var(--color-text-muted);">Tue-Sat:</span> 09:00 - 12:30 / 15:30 - 19:30
                            </div>
                        </li>
                    </ul>
                ...
                <div class="contact-form-wrapper reveal">
                    <form class="styled-form">
                        <h3 style="font-family: var(--font-serif); margin-bottom: 1.5rem; color: white; font-size: 1.8rem;">Send us a message</h3>
                        <p style="color: var(--color-text-muted); margin-bottom: 2rem;">Have a project in mind or want a quote?<br> Fill out the form.</p>
                        ...
                        <div class="form-group">
                            <label>Message</label>
                            <textarea rows="5" placeholder="Describe your project or request..."></textarea>
                        </div>

                        <button type="submit" class="btn btn-gold w-full" style="margin-top: 1rem;">Send request</button>
                    </form>
                </div>
